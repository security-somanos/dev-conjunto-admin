        ...
        <div class="line status" >
          ...
          <b-form-group
            ...
            <b-form-input id="nested-date" type="text"
              v-model="sale[0].date"
              @change="updateUserInfo($event, sale['.key'], '0/date')" disabled></b-form-input>
          </b-form-group>
          <b-form-group
            label-cols-sm="3"
            label="Nombre:"
            ...
            <b-form-input id="nested-name" type="text"
              v-model="sale[0].name"
              @change="updateUserInfo($event, sale['.key'], '0/name')" disabled ></b-form-input>
          </b-form-group>
          <b-form-group
            label-cols-sm="3"
            label="Dirección:"
            ...
            <b-form-input id="nested-direccion"
              ...
              @change="updateUserInfo($event, sale['.key'], '0/address')" disabled></b-form-input>
          </b-form-group>
          <b-form-group
            label-cols-sm="3"
            label="Localidad:"
            ...
            <b-form-input id="nested-localidad"
              ...
              @change="updateUserInfo($event, sale['.key'], '0/localidad')" disabled></b-form-input>
          </b-form-group>
          <b-form-group
            label-cols-sm="3"
            label="Cel:"
          ...
          <b-form-group
            ...
            <b-form-input id="nested-nodo"
              ...
              @change="updateUserInfo($event, sale['.key'], '0/email')" disabled></b-form-input>
          </b-form-group>
      </b-card>
      <b-card bg-variant="light">
        <b-form-group
          ...
          <b-form-input id="nested-totalventa"
            ...
            @change="updateUserInfo($event, sale['.key'], '0/total')" disabled></b-form-input>
        </b-form-group>
        <b-form-group
          label-cols-sm="3"
          ...
          <b-form-input id="nested-cantidad"
            ...
            @change="updateUserInfo($event, sale['.key'], '0/totalCantidad')" disabled></b-form-input>
        </b-form-group>
        <b-form-group
          label-cols-sm="3"
          label="Total Costo:"
        ...
        <b-form-group
          ...
          label-align-sm="right"
          label-for="nested-totalventa">
          <b-form-input id="nested-totalpago"
            type="text"
            v-model="sale[0].pago"
...
const salesRef = db.ref("salesArchive/mayorista");
